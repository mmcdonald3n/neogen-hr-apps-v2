...
st.set_page_config(page_title="Neogen — Policy Generator", page_icon=None, layout="wide")
...
with right:
    ...
    st.caption("Draft policy documents with Neogen tone, sections and compliance notes.")
