...
st.set_page_config(page_title="Neogen — Interview Feedback Collector", page_icon=None, layout="wide")
...
with left:
    try:
        ...
        pass
with right:
    st.title("Interview Feedback Collector")
    st.caption("Collect structured feedback and surface signal vs noise.")
